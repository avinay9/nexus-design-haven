      ...
      <div className="container-academy">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            <p className="eyebrow mb-4">Academic Programs</p>
            <h2 className="text-4xl lg:text-5xl font-bold text-primary leading-[1.05]">
              Disciplines that shape tomorrow.
            </h2>
          </div>
          <p className="text-muted-foreground max-w-md">
            Six rigorous programs, one interdisciplinary spirit. Choose your craft
            — collaborate across all of them.
          </p>
        </div>
